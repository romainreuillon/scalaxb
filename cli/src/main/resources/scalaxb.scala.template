...
object Helper {
  ...
  def attributesToMap(node: Node)(implicit ev: XMLFormat[String]) =
  ...
  def mapToAttributes(attrs: scala.collection.Map[String, DataRecord[Any]], scope: NamespaceBinding)(implicit ev: XMLFormat[String]): scala.xml.MetaData = {
